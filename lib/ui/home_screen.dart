                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) =>
                          ...
                          child: Image.asset(
                              "assets/images/carousel${index+1}.png", fit: BoxFit.fill,),
                        ),
                      ),
                    ),
                    Container(
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        scrollDirection: Axis.horizontal,
                        itemCount: 3,
                        itemBuilder: (BuildContext context, int index) => Group24Widget()
                      ),
                    ),
        ...
        child: Stack(
            children: <Widget>[
              Positioned(
                  ...
                  top: 15,
                  left: 15,
                  child: Text('Today | 12:30 PM', textAlign: TextAlign.left, style: TextStyle(
                  ...
                  top: 149,
                  left: 128,
                  child: Text('Leagues Name', textAlign: TextAlign.left, style: TextStyle(
                      color: Color.fromRGBO(255, 255, 255, 1),
                      fontFamily: 'Poppins',
                      fontSize: 12,
                      letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: const <Widget>[
                        Text('Upcomming', textAlign: TextAlign.left, style: TextStyle(
                            color: Color.fromRGBO(255, 255, 255, 1),
                            fontFamily: 'Poppins',
                            fontSize: 10,
                            letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                          ...
                          children: <Widget>[
                            Positioned(
                                ...
                                child: Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      image : DecorationImage(
                                          image: AssetImage('assets/images/game_icon1.png'),
                                          fit: BoxFit.fitWidth
                                      ),
                                    )
                                )
                                ...
                                child: Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      image : DecorationImage(
                                          image: AssetImage('assets/images/game_icon2.png'),
                                          fit: BoxFit.fitWidth
                                      ),
                                    )
                                )
                                ...
                                top: 12,
                                left: 92,
                                child: Text('VS', textAlign: TextAlign.left, style: TextStyle(
                                    color: Color.fromRGBO(255, 255, 255, 1),
                                    fontFamily: 'Poppins',
                                    fontSize: 14,
                                    letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
